...
#define STARFIVE_SYSCRG_CLK_APB_TIMER (STARFIVE_SYS_CRG_BASE + 0x1f0)
#define STARFIVE_SYSCRG_CLK_TIMER(X) (STARFIVE_SYS_CRG_BASE + 0x1f4 + (4*X))
#define STARFIVE_SYSCRG_CLK_ENABLE_BIT BIT(31)
